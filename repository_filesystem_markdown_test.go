...
func TestGetIssuesWhenNoIssuesInFolderThenReturnsEmptyArray(t *testing.T) {
	// arrange
	repository, inMemFs := newInMemFilesystemMarkdownIssuesRepository()
...
func TestGetIssuesWhenNoIssuesFolderThenReturnsError(t *testing.T) {
	// arrange
	repository, _ := newInMemFilesystemMarkdownIssuesRepository()
...
func TestGetIssuesWhenCantReadFileThenItReturnsAnError(t *testing.T) {
	...
	repository := FilesystemMarkdownIssuesRepository{
		Fs: mockFilesystem{
...
func newInMemFilesystemMarkdownIssuesRepository() (FilesystemMarkdownIssuesRepository, afero.Fs) {
